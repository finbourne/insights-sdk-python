...
def main():
    ...
    try:
        ...
        # api_response =  api_instance.get_vendor_log(id, opts=opts)
...
def main():
    ...
    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.get_vendor_request(id, opts=opts)
...
def main():
    ...
    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.get_vendor_response(id, opts=opts)
...
def main():
    ...
    try:
        # uncomment the below to set overrides at the request level
        # api_response =  api_instance.list_vendor_logs(filter=filter, sort_by=sort_by, limit=limit, page=page, histogram_interval=histogram_interval, opts=opts)
