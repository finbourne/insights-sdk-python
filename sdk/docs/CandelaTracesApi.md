...
def main():
    ...
    trace_id = 'trace_id_example' # str | The identifier of the trace.
    ...
    try:
        ...
        print("Exception when calling CandelaTracesApi->get_trace_diagram: %s\n" % e)
...
def main():
    ...
    page = 'page_example' # str | Encoded pagwwwwe string returned from a previous search result that will retrieve the next page of data. When this field is supplied, filter and sortby fields should not be supplied. (optional)
