...
from finbourne_insights.api_client import ApiClient as AsyncApiClient
...
import finbourne_insights.extensions.retry as retry
from finbourne_insights.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_insights.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for finbourne_insights if needed
