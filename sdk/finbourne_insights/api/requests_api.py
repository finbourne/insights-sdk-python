...
class RequestsApi:
    ...
    @overload
    async def query_request_logs(self, query_request_logs_request : Annotated[QueryRequestLogsRequest, Field(description="The query parameters in the request body.")], **kwargs) -> ResourceListOfQueriedRequestLog:  # noqa: E501
        ...

    @overload
    def query_request_logs(self, query_request_logs_request : Annotated[QueryRequestLogsRequest, Field(description="The query parameters in the request body.")], async_req: Optional[bool]=True, **kwargs) -> ResourceListOfQueriedRequestLog:  # noqa: E501
        ...

    @validate_arguments
    def query_request_logs(self, query_request_logs_request : Annotated[QueryRequestLogsRequest, Field(description="The query parameters in the request body.")], async_req: Optional[bool]=None, **kwargs) -> Union[ResourceListOfQueriedRequestLog, Awaitable[ResourceListOfQueriedRequestLog]]:  # noqa: E501
        """QueryRequestLogs: Query the logs for API requests, returning only the caller-specified fields in addition to the always-required fields (Timestamp, Id, Application, Operation). The server fetches only the requested columns from the underlying data source to minimise payload and query time.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.query_request_logs(query_request_logs_request, async_req=True)
        >>> result = thread.get()

        :param query_request_logs_request: The query parameters in the request body. (required)
        :type query_request_logs_request: QueryRequestLogsRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: Timeout setting. Do not use - use the opts parameter instead
        :param opts: Configuration options for this request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ResourceListOfQueriedRequestLog
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the query_request_logs_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.query_request_logs_with_http_info(query_request_logs_request, **kwargs)  # noqa: E501

    @validate_arguments
    def query_request_logs_with_http_info(self, query_request_logs_request : Annotated[QueryRequestLogsRequest, Field(description="The query parameters in the request body.")], **kwargs) -> ApiResponse:  # noqa: E501
        """QueryRequestLogs: Query the logs for API requests, returning only the caller-specified fields in addition to the always-required fields (Timestamp, Id, Application, Operation). The server fetches only the requested columns from the underlying data source to minimise payload and query time.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.query_request_logs_with_http_info(query_request_logs_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ResourceListOfQueriedRequestLog, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'query_request_logs_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_request_logs" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['query_request_logs_request'] is not None:
            _body_params = _params['query_request_logs_request']
        ...
        _response_types_map = {
            '200': "ResourceListOfQueriedRequestLog",
            '400': "LusidValidationProblemDetails",
        }

        return self.api_client.call_api(
            '/api/requests/$query', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
